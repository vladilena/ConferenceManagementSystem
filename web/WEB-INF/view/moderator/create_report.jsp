    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <form role="form" method="post" action="${pageContext.request.contextPath}/conf?action=create_report">
                ...
                <div class="form-group row">
                    <label for="date" class="col-sm-4 col-form-label"><fmt:message
                            key="text.conference.dateTime"/></label>
                    <div class="col-sm-8">
                ...
                <button type="submit" class="btn btn-block btn-outline-dark"
                        style="background-color: #5a6268; color: #c8cbcf"><fmt:message key="text.send"/></button>
            </form>
        </div>
        <div class="col-3"></div>
    </div>
